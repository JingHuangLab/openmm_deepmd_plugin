...
nsteps = 100000
nstout = 100
time_step = 0.1  # unit is femtosecond.
...
sim.reporters.append(
        StateDataReporter(sys.stdout, nstout, step=True, time=True, totalEnergy=True, kineticEnergy=True, potentialEnergy=True, temperature=True, progress=True,
