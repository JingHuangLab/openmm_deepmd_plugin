...
def run_deepmd_nvt_cuda(nsteps = 1000, time_step = 0.2, platform_name = "CUDA", output_temp_dir = "/tmp/openmm_deepmd_plugin_test_nvt_output", temperature_std_tol = 25 ):
...
if __name__ == "__main__":
    ...
    run_deepmd_nvt_cuda(nsteps=nsteps, time_step=time_step)
